...
-   **면접 기록**: 과거에 진행했던 모든 면접 기록을 저장하고 다시 불러와 확인할 수 있습니다.
...
- 아쉬운점을 말씀드리자면 , 일단 UI나 UX 부분은 만족스럽지만 안정성이 조금 떨어지는게 보여서 아쉬운것 같고, 면접을 보는 과정에서 ai 질문을 받는것과 사용자가 답변을 했을때에 피드백을 받는부분?에서 좀 부족한 느낌을 받았습니다. 이 부분들을 수정을 못했던게 너무 아쉽습니다.
